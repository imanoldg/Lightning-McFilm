...
const UserProfile = () => {
  ...
  if (loading || !user) {
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center">
        <p className="text-4xl font-bold text-mc-red">{t('common.loading')}</p>
      </div>
    );
  }
  ...
  const renderPosters = (movies) => {
    if (movies.length === 0) {
      return <p className="text-gray-500 col-span-full text-center py-12 text-xl">{t('myLists.empty')}</p>;
    }
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="container mx-auto px-6 py-12 max-w-7xl">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-800 mb-8">{t('profile.recent')}</h2>
        ...
        <section>
          <h2 className="text-3xl font-bold text-gray-800 mb-8">{t('profile.favorites')}</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-8">
